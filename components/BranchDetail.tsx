  ...
  return (
    <>
      ...
      <section className="relative h-[100dvh] min-h-[560px] w-full overflow-hidden">
        ...
        />
        <div className="absolute bottom-0 left-0 right-0 max-w-6xl mx-auto px-5 sm:px-8 pb-14 sm:pb-20">
          <motion.div
          ...
          >
            <div>
              ...
              <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black text-white leading-[0.95]">
                {name}
              </h1>
            </div>
            <span
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 py-10 sm:py-14">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 text-sm font-medium mb-8 transition-colors hover:text-gold"
            ...
            {branch.images.map((src, i) => (
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/25 transition-all duration-300 flex items-center justify-center">
                  <svg className="text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5, ease }}
        >
          <SectionLabel>{tr.openInMap}</SectionLabel>
